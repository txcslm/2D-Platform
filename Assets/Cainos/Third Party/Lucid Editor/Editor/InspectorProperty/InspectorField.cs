...
namespace Cainos.LucidEditor
{
    public class InspectorField : InspectorProperty
    {
        ...
        private void DrawSerializeReferenceField(Rect position, InspectorField property)
        {
            ...
            buttonLabel.text =
                $"{(property.serializedProperty.managedReferenceValue == null ? "Null" : property.serializedProperty.managedReferenceValue.GetType().Name)} ({GetManagedReferenceFieldTypeName(property.serializedProperty)})";
